...
// lấy biến truyền từ client (script.js)
...
if (!empty($mission_id)) {
    ...
    // lấy mảng giá trị của email và tổng số nhiệm vụ ($emails và $values là 2 mảng dùng cho biểu đồ)
    ...
    $table_html .= '<td>Count mission</td>';
    $table_html .= '</tr>';
    $table_html .= '</thead>';
    $table_html .= '<tbody>';
