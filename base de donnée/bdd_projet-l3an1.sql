...
--
-- Hôte : localhost
-- Généré le : Dim 11 avr. 2021 à 14:38
...
(17, 1424, 1, 'application 1', '2021-03-31', 'benjaminbenharbon@gmail.com', 'lova.rakotozafy@mazars.fr', 'roch.ethan@mazars.fr', 'Documenté', 'Moyen', 'Non effectif', 'Non effectif', 1, 1),
(28, 1424, 1, 'application 2', '2021-03-24', 'benjaminbenharbon@gmail.com', 'lova.rakotozafy@mazars.fr', 'berth.paul@mazars.fr', 'Non débuté', 'Moyen', 'Non effectif', 'Effectif', 1, 1),
(33, 1424, 1, 'application 2', '2021-04-01', 'arbouche.anas@mazars.fr', 'lova.rakotozafy@mazars.fr', 'roch.ethan@mazars.fr', 'Non débuté', 'Moyen', 'Non effectif', 'Non effectif', 1, 1),
(44, 1425, 2, 'application mazars', '2021-04-11', 'nachet.haroune@mazars.fr', 'chouat.david@mazars.fr', 'berth.paul@mazars.fr', 'Non débuté', 'Moyen', 'Remarque mineure', 'Remarque majeure', 1, 1),
(45, 1425, 2, 'application', '2021-04-11', 'nachet.haroune@mazars.fr', 'benjaminbenharbon@gmail.com', 'lova.rakotozafy@mazars.fr', 'Non débuté', 'Élevé', 'Non effectif', 'Non effectif', 1, 1),
(46, 1426, 2, 'application', '2021-04-11', 'benjaminbenharbon@gmail.com', 'roch.ethan@mazars.fr', 'chouat.david@mazars.fr', 'Documenté', 'Élevé', 'Non effectif', 'Remarque mineure', 1, 1);
...
(17, 'lova.rakotozafy@mazars.fr', 'Associé', 1425),
(20, 'arbouche.anas@mazars.fr', 'Junior', 1428),
(21, 'benjaminbenharbon@gmail.com', 'Junior', 1426),
(24, 'berth.paul@mazars.fr', 'Senior manager', 1428),
(34, 'nachet.haroune@mazars.fr', 'Junior', 1425),
...
(27, 17, 'CV_2021-03-21_Benjamin_Benharbon.pdf', 'p_60585e75e3f27CV_2021-03-21_Benjamin_Benharbon.pdf', '2021-03-22', 'benjaminbenharbon@gmail.com', 'pyiugh', 'Fiches de travail'),
(42, 38, '04_cr_lacoudre.docx', 'p_6072b2bd6e18404_cr_lacoudre.docx', '2021-04-11', 'chouat.david@mazars.fr', 'fgc', 'Fiches de travail'),
(43, 34, '04_cr_lacoudre.docx', 'p_6072b3cf7402204_cr_lacoudre.docx', '2021-04-11', 'chouat.david@mazars.fr', 'pyiugh', 'Preuves'),
(44, 43, '04_cr_lacoudre.docx', 'p_6072b6539868c04_cr_lacoudre.docx', '2021-04-11', 'chouat.david@mazars.fr', 'pyiugh', 'Preuves');
...
(1428, 'mission_test', 'pixars.disney@mazars.fr'),
(1429, 'test test', 'chouat.david@mazars.fr'),
(1430, 'Natixis', 'chouat.david@mazars.fr'),
(1431, 'test Mazars', 'chouat.david@mazars.fr'),
(1441, 'test', 'chouat.david@mazars.fr'),
(1442, 'CREDIT AGRICOLE', 'chouat.david@mazars.fr');
...
--
ALTER TABLE `mission`
  MODIFY `mission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1443;
