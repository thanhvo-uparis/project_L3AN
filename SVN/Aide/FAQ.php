        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingSeven">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSeven" aria-expanded="false" aria-controls="flush-collapseSeven">
                  Comment ajouter des gens a une mission ?
                </button>
              </h2>
              <div id="flush-collapseSeven" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Pour cela, il suffit d'aller sur la rubrique équipe et cliquer sur l'outil intitulé <i>ajouter une personne</i>, une pop-up s'ouvrira et il vous suffiras simplement de spécifier dans qu'elle mission vous désirez l'ajouter.</div>
              </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="flush-collapseL" class="accordion-collapse collapse" aria-labelledby="flush-headingL" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Pour cela, il vous suffit d'aller dans la rubrique "Documentation", une fois sur cette page il vous suffit de faire un double click sur le commentaires du contrôle dans lequel vous voulez le modifier et ensuite vous clicker sur le bouton "modifier".</div>
                </div>
              </div>
              <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingK">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseK" aria-expanded="false" aria-controls="flush-collapseK">
                    Ou puis-je retrouver mon équipe ?
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingJ">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseJ" aria-expanded="false" aria-controls="flush-collapseJ">
                    Puis-je ajouter une catégorie a une mission ?
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingH">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseH" aria-expanded="false" aria-controls="flush-collapseH">
                    Comment faire pour retrouver des informations sur une personne précises ?
                  </button>
                </h2>
            ...
            <h2 class="accordion-header" id="flush-headingG">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseG" aria-expanded="false" aria-controls="flush-collapseG">
                    Comment puis-je accéder a mon activité personnelle ?
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingF">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseF" aria-expanded="false" aria-controls="flush-collapseF">
                    Comment je peux faire pour ajouter des fichiers a mes contrôles ?
                  </button>
                </h2>
                <div id="flush-collapseF" class="accordion-collapse collapse" aria-labelledby="flush-headingF" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Aller dans la rubrique <strong>Documentation</strong>, puis cliquez sur le contrôle dans lequel vous souhaitez ajouter un fichier et pour finir cliquez sur <strong>Ajout d'un fichier</strong>.</div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseE" class="accordion-collapse collapse" aria-labelledby="flush-headingE" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Aller dans la rubrique <strong>Documentation</strong>, puis <strong>double cliquer sur le champ commentaire</strong> dans le contrle dans lequel vous souhaitez modifier le commentaire, une fois sur la pop-up il faut cliquer sur <strong>modifier</strong>.</div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseD" class="accordion-collapse collapse" aria-labelledby="flush-headingD" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Il suffit d'aller dans la rubrique <strong>Documentation</strong>, puis double clicker sur les champs du contrôle que vous souhaitez modifier(statut, niveau de risque, design , efficacite).</div>
                </div>
              </div>
              <div class="accordion-item">
